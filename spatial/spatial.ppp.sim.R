...
# Simulate observed locations by sampling cells with probability proportional to lambda.
...
##########################################################
### Fit model using Poisson point process model
##########################################################

source('~/Documents/git/PPM/spatial/spatial.ppp.mcmc.R')
priors <- list(sigma.beta=2)
tune <- list(beta=0.1)
